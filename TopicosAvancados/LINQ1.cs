    ...
    internal class LINQ1
    {
        public static void Executar() {
            ...
            foreach (var aluno in aprovados) {
                Console.WriteLine(aluno.Nome); // (1)
            }
...
// (1) Here, we're printing the attribute "Nome" from the OBJECT "aluno".
//
// (2) Here, we're printing only the strings ordered by name, not the OBJECT "aluno" anymore. 
